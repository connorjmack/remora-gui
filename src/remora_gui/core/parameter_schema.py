...
_OUTPUT_PARAMS: list[REMORAParameter] = [
    ...
    REMORAParameter(
        key="remora.plot_vars",
        label="Plot Variables",
        description="Which fields to output in plot files (space-separated).",
        group="output",
        dtype="string_list",
    ...
    REMORAParameter(
        key="remora.v",
        label="Verbosity",
        description="Console output verbosity level (0=silent, 1=summary, 2=detailed).",
        group="output",
        dtype="int",
        default=1,
        min_value=0,
